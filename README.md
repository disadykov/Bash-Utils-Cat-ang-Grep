...
## Компиляция и запуск
Утилиты разрабатывались и тестировались в ОС **`Ubuntu desktop 22.04`**
...
- `make clean` - удалить временные файлы и файлы сборки

Набор дейстивий по компиляции и запуску `grep` аналогичен
